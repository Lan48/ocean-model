...
class Trainer(transformers.Trainer):
    ...
    def create_scheduler(self, num_training_steps: int, optimizer: torch.optim.Optimizer = None):
        if self.lr_scheduler is None:
            ...
            if self.args.lr_scheduler_type_custom is not None:
                name = self.args.lr_scheduler_type_custom
    ...
    def _get_train_sampler(self) -> Optional[torch.utils.data.Sampler]:
        ...
        if self.args.world_size <= 1:
            ...
            return DistributedSampler(#DistributedReplaySampler(
                self.train_dataset,
                    ...
                    if args.max_grad_norm is not None and args.max_grad_norm > 0 and not self.deepspeed:
                        ...
                        if hasattr(self.optimizer, "clip_grad_norm"):
                            ...
                            nn.utils.clip_grad_norm_(
                                model.parameters(), #amp.master_params(self.optimizer) if self.use_apex else model.parameters(),
                                args.max_grad_norm,
                            )
